...
export default function Mission() {
    return (
        <div>
            ...
            <div class="bg-secondary h-[100rem] overflow-hidden max-xl:h-[70rem] max-sm:h-[40rem] max-xs:h-[35rem]">
                <div class="relative">
                    <div>
                        <div class="flex justify-center items-center gap-[2rem] mt-[10rem]">
                            <div class="bg-primary w-[37rem] h-[12.5rem] rounded-[1.5rem] relative overflow-hidden">
                            ...
                            <div class="bg-red-200 w-[37rem] h-[12.5rem] rounded-[1.5rem]">
                                <div class="bg-white w-[37rem] h-[12.5rem] rounded-[1.5rem] relative overflow-hidden">
                                    <div class="absolute right-[-0.5rem] top-[-1rem]">
                    ...
                    <div>
                        <div class="flex justify-center items-center mt-[5rem]">
                            <img class="w-[76rem] h-[40rem] rounded-[1.5rem] object-obtain" src={image1} />
                        </div>
                    </div>
                    <div>
                        <div class="w-[78%] h-[13rem] bg-tertiary ml-[22%] absolute bottom-[-6.5rem] rounded-l-[1.5rem]">
                            <div class="flex justify-evenly">
                                <div class="mt-[3rem]">
                                    <h1 class="text-primary text-[2.5rem]">150+</h1>
                                    <h4 class="text-white text-[1.5rem]">Team Members</h4>
                                </div>
                                <div class="h-[8rem] border-l-2 border-l-gray-100/20 mt-[2.2rem]"></div>
                                <div class="mt-[3rem]">
                                    <h1 class="text-primary text-[2.5rem]">60,000+</h1>
                                    <h4 class="text-white text-[1.5rem]">Happy Guests</h4>
                                </div>
                                <div class="h-[8rem] border-l-2 border-l-gray-100/20 mt-[2.2rem]"></div>
                                <div class="mt-[3rem]">
                                    <h1 class="text-primary text-[2.5rem]">99%</h1>
                                    <h4 class="text-white text-[1.5rem]">Guest Satisfaction</h4>
                                </div>
                                <div class="h-[8rem] border-l-2 border-l-gray-100/20 mt-[2.2rem]"></div>
                                <div class="mt-[3rem]">
                                    <h1 class="text-primary text-[2.5rem]">18+</h1>
                                    <h4 class="text-white text-[1.5rem]">Years Experience</h4>
                                </div>
                            </div>
                        </div>
                    </div>
