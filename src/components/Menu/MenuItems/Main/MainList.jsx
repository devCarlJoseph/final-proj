import AppetizerOne from "../../../../assets/pictures/pesto zucchini.jpg"
import AppetizerTwo from "../../../../assets/pictures/pepperoni.jpg"
import AppetizerThree from "../../../../assets/pictures/caprese.jpg"
import AppetizerFour from "../../../../assets/pictures/tacos.jpg"
import AppetizerFive from "../../../../assets/pictures/udon.jpg"
import AppetizerSix from "../../../../assets/pictures/Beef Stir Fry.jpg"
import AppetizerSeven from "../../../../assets/pictures/Lamb Chops with Mint Sauce.avif"
import AppetizerEight from "../../../../assets/pictures/Chicken Alfredo Pasta.jpg"
import AppetizerNine from "../../../../assets/pictures/Shepherd Pie.jpg"
import AppetizerTen from "../../../../assets/pictures/Peking Duck.jpg"
                ...
                <div className="flex flex-col gap-5">
                        ...
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem]">Pesto Zucchini Noodles</div>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] ">Caprese Carnival Crust</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] ">Udon Noodles</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] ">Lamb Chops with Mint Sauce</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] ">Shepherd Pie</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                ...
                <div className="flex flex-col gap-5">
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem]">Pepperoni Paradise Pie</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem]">Quinoa Tacos</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem]">Beef Stir Fry</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem]">Chicken Alfredo Pasta</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem]">Peking Duck</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
