                ...
                <div className="flex flex-col gap-5">
                        ...
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem]">Fruit Tart</div>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem] ">Baklava</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem] ">Choco Lava Cake</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem] ">Lemon Meringue Pie</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem] ">Profiteroles</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                ...
                <div className="flex flex-col gap-5">
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem]">Apple Pie</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem]">Cheesecake</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem]">Crème Brûlée</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem]">Mochi Ice Cream</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
                    ...
                    <div className="w-[34rem] h-[8.5rem] bg-white shadow-sm cp:w-[21.5rem] cp:h-[5.5rem]">
                        <div className="flex gap-1">
                            ...
                            <div className="w-[25rem]">
                                <div className="flex justify-between items-center px-2 pt-3.5 text-primary">
                                    <div className="font-semibold text-[1.05rem] cp:text-[1rem]">Tiramisu</div>
                                    <div className="text-[1.2rem] font-bold mr-2.5 cp:text-[0.9rem]">$35.00</div>
                                </div>
                                <div>
                                    <span className="text-[0.8rem] font-semibold px-2">Potato / Spices</span>
