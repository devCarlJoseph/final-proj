            ...
            <div class="flex justify-center items-center gap-4 mt-[3rem] tablet:flex-col">
                <div class="w-[35rem] h-[20.3rem] backdrop-blur-md bg-white/20 rounded-[1rem] border-1 border-white/20 cp:w-[20.5rem] cp:h-[18rem]">
                    ...
                    <div class="ml-[1rem] mt-[1rem] cp:mt-[0.5rem]">
                        ...
                        <p class="text-gray-300 pr-5 mt-[0.5rem] max-xl:mt-[0.5rem] max-sm:text-[0.8rem] cp:mt-[0.2rem] max-2xs:text-[0.75rem] cp:pr-3">The setting was romantic, with soft lighting and great background music. Our server was friendly and helped us choose a wonderful wine pairing. Each dish was creative and tasted amazing. Dessert was the perfect sweet ending to our evening. We felt relaxed and well taken care of the entire time. We're definitely coming back for our next special occasion.</p>
                    </div>
                    <div class="flex items-center gap-3 relative mt-[1rem] ml-[1rem] max-xl:mt-[0.7rem] cp:mt-[0.5rem]">
                        ...
                        <div class="mt-[0.3rem]">
                            <h1 class="text-white text-[1.2rem] cp:text-[1rem]">Elena & Marcus</h1>
                            <p class="text-gray-200 cp:text-[0.8rem]">Happy Guest</p>
                        </div>
                    </div>
                </div>
                <div class="w-[35rem] h-[20.3rem] backdrop-blur-md bg-white/20 rounded-[1rem] border-1 border-white/20 max-xl:w-[28rem] max-lg:w-[32rem] max-lg:h-[20.5rem] max-sm:w-[22rem] max-sm:h-[18rem] cp:w-[20rem] max-xs:h-[17rem] max-2xs:w-[18rem] max-2xs:h-[16.5rem]">
                    <div class="flex gap-2 ml-[1rem] mt-[1rem] max-xs:mt-[0.5rem]">
                        <div class="flex gap-1 items-center text-[1.3rem] text-yellow-500 max-sm:text-[1rem]">
