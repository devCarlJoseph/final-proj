...
export default function Two() {
    return (
        <div>
            <div class="flex justify-center items-center gap-4 mt-[3rem] tablet:flex-col cp:w-[10rem]">
                <div class="w-[35rem] h-[20.3rem] backdrop-blur-md bg-white/20 rounded-[1rem] border-1 border-white/20 max-xl:w-[28rem] max-lg:w-[32rem] max-lg:h-[20.5rem] max-sm:w-[22rem] max-sm:h-[18rem] max-xs:w-[20rem] max-xs:h-[17rem] max-2xs:w-[18rem] max-2xs:h-[16.5rem]">
                    ...
                    <div class="ml-[1rem] mt-[1rem] max-xs:mt-[0.5rem]">
                        <h1 class="text-[1.5rem] text-white font-medium max-sm:text-[1.2rem] max-2xs:text-[1.1rem]">Absolutely fantastic!</h1>
                        <p class="text-gray-300 pr-5 mt-[0.5rem] max-xl:mt-[0.5rem] max-sm:text-[0.8rem] max-xs:mt-[0.2rem] max-2xs:text-[0.75rem] max-xs:pr-3">We were greeted with warm smiles the moment we walked in. The staff made us feel welcomed and taken care of the entire evening. The food was beautifully presented and packed with flavor. The cozy and inviting atmosphere added to the experience. I especially loved the house special—it was unforgettable. We’ll definitely be back soon!</p>
                    </div>
                    <div class="flex items-center gap-3 relative mt-[1rem] ml-[1rem] max-xl:mt-[0.7rem] max-xs:mt-[0.5rem]">
                        ...
                        <div class="mt-[0.3rem]">
                            <h1 class="text-white text-[1.2rem] max-xs:text-[1rem]">Amanda R.</h1>
                ...
                <div class="w-[35rem] h-[20.3rem] backdrop-blur-md bg-white/20 rounded-[1rem] border-1 border-white/20 max-xl:w-[28rem] max-lg:w-[32rem] max-lg:h-[20.5rem] max-sm:w-[22rem] max-sm:h-[18rem] max-xs:w-[20rem] max-xs:h-[17rem] max-2xs:w-[18rem] max-2xs:h-[16.5rem]">
                    ...
                    <div class="ml-[1rem] mt-[1rem] max-xs:mt-[0.5rem]">
                        <h1 class="text-[1.5rem] text-white font-medium max-sm:text-[1.2rem] max-2xs:text-[1.1rem]">A hidden gem!</h1>
                    ...
                    <div class="flex items-center gap-3 relative mt-[1rem] ml-[1rem] max-xl:mt-[0.7rem] max-xs:mt-[0.5rem]">
                        ...
                        <div class="w-[3.5rem] h-[3.5rem] border-2 border-white rounded-[50%] absolute top-1 left-[0.25rem]  max-xs:w-[3rem] max-xs:h-[3rem] max-sm:top-[0.25rem] max-2xs:top-[0.3rem]"></div>
                        <div class="mt-[0.3rem]">
                            <h1 class="text-white text-[1.2rem] max-xs:text-[1rem]">James T</h1>
                            <p class="text-gray-200 max-xs:text-[0.8rem]">Happy Guest</p>
                        </div>
                    </div>
                </div>
