...
export default function ChefOne() {
    return (
        <div>
            ...
            <div className="bg-background h-[65.5rem] tablet:h-[58rem]">
                <div className="flex justify-center items-center gap-[2rem] mt-[-0.5rem] tablet:flex-col">
                    <div>
                        <img src={ChefImage} className="w-[32rem] h-[32rem] rounded-[1rem] object-cover rounded-t-[50%] cp:w-[24rem] cp:h-[24rem]" />
                    </div>
