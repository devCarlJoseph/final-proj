            ...
            <div className="bg-background h-[30rem] tablet:h-[50rem] cp:h-[60rem] myPhone:h-[65rem] sCP:h-[68rem]">
                <div>
                    ...
                    <div className="w-[73.7rem] ml-[10.7rem] text-justify tablet:w-[40rem] tablet:ml-[4rem] cp:w-[24rem] cp:ml-[1.35rem] cpM:w-[21rem] myPhone:w-[20rem] sCP:w-[18rem] sCP:pr-[0.8rem]">
                        ...
                        <p className="mt-[1rem]">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique atque explicabo sit tempore incidunt quam quibusdam quae et ea exercitationem consequatur, aut assumenda nihil repellat quis doloribus corporis illum. Dolores.
                        </p>
                    </div>
                </div>
                <div className="flex justify-center items-center mt-[2.5rem]">
                    <div className="w-[73.7rem] h-[10rem] flex justify-center items-center gap-[1.4rem] cp:flex-col cp:mt-[7rem]">
                        <div className="w-[49%] flex flex-col gap-[2rem] tablet:w-[40%] cp:w-[75%]">
                            <div className="flex flex-col gap-[0.5rem]">
                                ...
                                <div>
                                    <div>
                                        <div className="w-full h-[0.6rem] rounded-[2rem] bg-gray-200">
                                            <div className="w-[85%] h-[0.6rem] bg-primary relative rounded-[2rem]">
                                                <div className="absolute top-[-0.6rem] left-[96%]">
                                                    <div className="flex justify-center items-center w-[2rem] h-[2rem] bg-primary rounded-[50%]">
                                                        <div className="w-[1.5rem] h-[1.5rem] rounded-[50%] bg-white"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="flex flex-col gap-[0.5rem]">
                                ...
                                <div>
                                    <div>
                                        <div className="w-full h-[0.6rem] rounded-[2rem] bg-gray-200">
                                            <div className="w-[80%] h-[0.6rem] bg-primary relative rounded-[2rem]">
                                                <div className="absolute top-[-0.6rem] left-[96%]">
                                                    <div className="flex justify-center items-center w-[2rem] h-[2rem] bg-primary rounded-[50%]">
                                                        <div className="w-[1.5rem] h-[1.5rem] rounded-[50%] bg-white"></div>
                                                    </div>
                            ...
                            <div className="flex flex-col gap-[0.5rem]">
                                ...
                                <div>
                                    <div>
                                        <div className="w-full h-[0.6rem] rounded-[2rem] bg-gray-200">
                                            <div className="w-[95%] h-[0.6rem] bg-primary relative rounded-[2rem]">
                                                <div className="absolute top-[-0.6rem] left-[96%]">
                                                    <div className="flex justify-center items-center w-[2rem] h-[2rem] bg-primary rounded-[50%]">
                                                        <div className="w-[1.5rem] h-[1.5rem] rounded-[50%] bg-white"></div>
                                                    </div>
