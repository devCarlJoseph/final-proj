            ...
            <div className='flex justify-center items-center'>
                <div className='flex justify-between w-[85%] border-b-[1px] border-b-gray-200 absolute top-1'>
                    ...
                    <div className='mt-[1.5rem] mb-[0.7rem]'>
                        <i class="fa-solid fa-bars text-[1.3rem] mr-[-6.5rem] text-white cursor-pointer hidden tablet:block tablet:ml-[19rem] cp:ml-[3.5rem] cpM:ml-[2.5rem] myPhone:ml-[2rem] sCP:ml-[1rem]"
                        onClick={() => setNavOpen(!navOpen)}></i>
                        <ul className={`${navOpen ? 'flex flex-col items-center gap-4 mt-4 bg-tertiary w-[41rem] h-[17.2rem] absolute left-0 pt-[0.7rem] rounded-[0.5rem] cp:w-[23rem] myPhone:w-[19.15rem] sCP:w-[17rem] lg:hidden' : 'block tablet:hidden'} flex gap-[2rem] cursor-pointer text-white font-medium z-[2]`}>
